...
jsPsych.plugins["judgmentTest"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += "<h2>Decision test (Cycle "+(count_judgment+1)+"):  Question "+((t_judge+1)+(t_judge_block*(n_families*n_subFamilies)))+ " - a total of " 
      +n_families*n_subFamilies*n_blocks_judgment+" questions</h2>";
    ...
    //show prompt
    var prompt_judgmentTest = "<p id='prompt_judgmentTest'>Does this dinosaur belong to the <b>"
    +names_tobeDisplayed_judgment_curBlock[t_judge]+"</b> family?</p>";
    ...
    function after_response_yn(choice) {
      ...
      document.getElementById('prompt_confRating').innerHTML='How confident are you in your decision?';
