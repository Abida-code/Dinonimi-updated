...
jsPsych.plugins["labelExemplar"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var prompt = "<p id='prompt' >Given these characteristics, to which family does this species belong?</p>";
    html += prompt;
    //display buttons
    var buttons = [];
    ...
    function after_response(choice) {
      ...
      function addBtn(){
          document.getElementById('btnHolder').innerHTML = '<input type="button" class="jspsych-btn" id="doneButton2" value="Next" />';
        };
      addBtn();
